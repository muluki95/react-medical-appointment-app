        ...
        <div className="signup-text">
          ...
          <div className="login-form">
                ...
                <div className="btn-group">
                    <button type="submit" className="btn btn-primary mb-2 mr-1 waves-effect waves-light"> Register </button>
                </div>
              <div className="signup-text1">
            Already a member? <span><Link to="/login" style={{ color: '#2190FF' }}> Login Here</Link></span>
          </div>
              </div>
            </form>
         </div>
